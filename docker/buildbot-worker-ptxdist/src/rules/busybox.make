...
ifdef PTXCONF_BUSYBOX_SELINUX
BUSYBOX_MAKE_OPT += CFLAGS="-I$(SYSROOT)/usr/include"
BUSYBOX_MAKE_OPT += LDFLAGS="-L$(SYSROOT)/usr/lib"
BUSYBOX_MAKE_OPT += HOSTCFLAGS="-I$(PTXCONF_SYSROOT_HOST)/usr/include"
endif
